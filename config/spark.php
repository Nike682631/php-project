    ...
    'billables' => [
        ...
        'user' => [
            ...
            'plans' => [
                [
                    'name' => 'B2BWood Club',
                    'short_description' => 'B2BWood Club Membership',
                    'monthly_id' => env('STRIPE_PRICE_CLUB_MONTHLY'),
                    'yearly_id' => env('STRIPE_PRICE_CLUB_YEARLY'),
                    'features' => [
                        'Search Functionality Unlimited',
                        'Sales pages with Buy Now option',
                        'Personal introducton potential clients 100',
                ...
                [
                    'name' => 'B2BWood VIP',
                    'short_description' => 'Get all the features and support for your business',
                    'monthly_id' => env('STRIPE_PRICE_VIP_MONTHLY'),
                    'yearly_id' => env('STRIPE_PRICE_VIP_YEARLY'),
                    'features' => [
                        'Search Functionality Unlimited',
                        'Sales pages with Buy Now option',
                        'Personal introducton potential clients 600',
                        'Membership term 12 months',
                        'Empoyee accounts 3',
                        '+3 Months for free',
                    ],
